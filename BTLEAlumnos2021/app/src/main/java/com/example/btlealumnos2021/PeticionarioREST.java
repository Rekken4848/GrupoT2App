...
public class PeticionarioREST extends AsyncTask<Void, Void, Boolean> {
    ...
    public void hacerPeticionREST(String metodo, String urlDestino, String cuerpo, RespuestaREST laRespuesta) {
        ...
        Log.d( "PeticionarioReal", "Dentro");

        this.execute(); // otro thread ejecutará doInBackground()
    }

    // --------------------------------------------------------------------
    // Lista<parametros> --> doInBackground() --> VoF
    // otro thread ejecutará esto
    // --------------------------------------------------------------------
    @Override
    protected Boolean doInBackground(Void... params) {
        ...
        try {
            ...
            Log.d("clienterestandroid", "doInBackground(): ocurrio alguna otra excepcion: " + ex.getCause());
            Log.d("clienterestandroid", "doInBackground(): ocurrio alguna otra excepcion: " + ex);
    ...
    // --------------------------------------------------------------------
    // VoF --> onPostExecute() // otro thread ejecutará esto
    // --------------------------------------------------------------------
    ...
    // --------------------------------------------------------------------
    // Interfaz con la cual podemos definiar la respuesta a una peticion REST
    // --------------------------------------------------------------------
    public interface RespuestaREST {
        // Definicion de la respuesta a la peticion REST
